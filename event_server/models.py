"""Data models for session data management."""
...
@dataclass
class SessionData:
    """Represents the ephemeral data for a single transparency session.
    
    This data lives only in memory and dies when the container stops.
    """
